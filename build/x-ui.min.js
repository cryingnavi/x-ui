...
c=X.apply(d,c),c.viewport&&a("viewport","initial-scale="+d.initialScale+", maximum-scale="+d.maximumScale+", minimum-scale="+d.minimumScale+", user-scalable="+d.userScalable+", target-densitydpi="+d.targetDensityDpi),c.fullscreen&&(a("apple-mobile-web-app-capable","yes"),a("apple-touch-fullscreen","yes")),c.statusbar&&a("apple-mobile-web-app-status-bar-style",c.statusbar),c.splash&&b("apple-touch-startup-image",c.splash),c.icon&&b("apple-touch-icon",c.icon,c.iconsize),X.getDoc().ready(function(){var a={id:c.id,el:"body",autoSize:!0,autoRender:!0,scroll:!1};a=X.apply(a,c.viewConfig),X.App.View=new X.View(a),X.getDoc().on("vclick","a",{view:X.App.View},function(){{var a,b,c=$(this),d=c.attr("href"),e=c.data("transition")||"slide",f=c.data("history")===!1?!1:!0,g=c.data("back");c.attr("rel")}if(d)return d.match(/^tel\:/)?!0:(a=c.parents(".ui-view"),a.each(function(){var a=this.id,c=X.util.cm.get(a);return b=c.getViewController(),b?!1:void 0}),b?g&&"#"===d?(b.backPage(),!1):"#"!==d&&g?(b.prevPage({url:d}),!1):"#"!==d&&d?(b.nextPage({url:d,transition:e,history:f}),!1):!0:!1)}),c.ready&&c.ready(X.App.View),c=null,X.getDoc().bind("orientationchange",function(){return!1})})},X.getApp=function(){return X.App.View?X.App.View:null}}();